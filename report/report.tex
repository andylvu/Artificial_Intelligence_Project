...
\begin{table}[h]
  ...
  \caption{Custom dataset collected from Kroger showing food, food group, price and weight or calcuated weight. This example table is limited to ten selected entires from the dataset.}
